...
def arg_parse():
    ...
    parser.add_argument("--cfg", dest = 'cfgfile', help = "Config file", default = "cfg/yoloNetwork.cfg", type = str)
    parser.add_argument("--weights", dest = 'weightsfile', help = "weightsfile", default = "cfg/yolov3.weights", type = str)
    parser.add_argument("--resolution", dest = 'reso', help = "Input resolution of the network, must be multiple of 32", default = "416", type = str)
